...
class DexiNed(tf.keras.Model):
    ...
    def __init__(self,rgb_mean=None,
        ...
        self.block_1 = DoubleConvBlock(8, 16, stride=(2,2),use_act=False)
        self.block_2 = DoubleConvBlock(32,use_act=False)
        self.dblock_3 = _DenseBlock(2, 64)
        self.dblock_4 = _DenseBlock(3, 128)
        self.dblock_5 = _DenseBlock(3, 128)
        self.dblock_6 = _DenseBlock(3, 64)
        self.maxpool = layers.MaxPool2D(pool_size=(3, 3), strides=2, padding='same')

        # first skip connection
        self.side_1 = SingleConvBlock(32,k_size=(1,1),stride=(2,2),use_bs=True,
                                      w_init=weight_init)
        self.side_2 = SingleConvBlock(64,k_size=(1,1),stride=(2,2),use_bs=True,
                                      w_init=weight_init)
        self.side_3 = SingleConvBlock(128,k_size=(1,1),stride=(2,2),use_bs=True,
                                      w_init=weight_init)
        self.side_4 = SingleConvBlock(128,k_size=(1,1),stride=(1,1),use_bs=True,
                                      w_init=weight_init)
        # self.side_5 = SingleConvBlock(256,k_size=(1,1),stride=(1,1),use_bs=True,
        #                               w_init=weight_init)


        self.pre_dense_2 = SingleConvBlock(64,k_size=(1,1),stride=(2,2),
                                      w_init=weight_init) # use_bn=True
        self.pre_dense_3 = SingleConvBlock(64,k_size=(1,1),stride=(1,1),use_bs=True,
                                      w_init=weight_init)
        self.pre_dense_4 = SingleConvBlock(128,k_size=(1,1),stride=(1,1),use_bs=True,
                                      w_init=weight_init)
        self.pre_dense_5_0 = SingleConvBlock(128, k_size=(1,1),stride=(2,2),
                                      w_init=weight_init) # use_bn=True
        self.pre_dense_5 = SingleConvBlock(128,k_size=(1,1),stride=(1,1),use_bs=True,
                                      w_init=weight_init)
        self.pre_dense_6 = SingleConvBlock(64,k_size=(1,1),stride=(1,1),use_bs=True,
                                      w_init=weight_init)
